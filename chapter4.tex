...
\centering
\small
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} p{1.2cm} p{4.2cm} p{5.5cm} p{3.5cm}}\toprule
...
\begin{itemize}
\item \textbf{Chỉ mục ghép cho chuỗi thời gian}: Bảng \texttt{tracking\_record} liên tục nhận các điểm GPS và dữ liệu đo từ xa trong chuyến bay. Chỉ mục ghép trên \texttt{activity\_id} và \texttt{recorded\_at} tối ưu việc truy xuất tọa độ đo từ xa gần nhất cho bảng điều khiển giám sát trực tiếp, đồng thời giới hạn phạm vi quét trong một hoạt động giao hàng.
